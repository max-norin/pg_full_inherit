...
# О наследовании в PostgreSQL

В 16 и более ранних версиях PostgreSQL при наследовании таблицы наследуются только
колонки таблицы и ограничения `CHECK` и `NOT NULL`. Остальные ограничения и триггеры
не наследуются.

Если убрать наследование у таблицы, то
колонки, ограничения `CHECK` и `NOT NULL`, данные в дочерних таблицах остаются неизменными.
